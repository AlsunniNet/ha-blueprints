...
Automates lighting across single or multiple motion/occupancy sensors with staggered off delays, protected mode lights, and occupancy flash warnings.
...
| **Mode / Always-On Lights** | Optional | Lights turned on with motion that remain ON when motion clears (automatically protected from turning off). |
